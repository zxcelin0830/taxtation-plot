...
plt.figure()
plt.subplot(3, 4, 1)
plt.scatter(get_tax(25.0), get_pris(25.0), sizes=[0.25])
...
plt.subplot(3, 4, 2)
plt.scatter(get_tax(26.0), get_pris(26.0), sizes=[0.25])
...
plt.subplot(3, 4, 3)
plt.scatter(get_tax(27.0), get_pris(27.0), sizes=[0.25])
...
plt.subplot(3, 4, 4)
plt.scatter(get_tax(28.0), get_pris(28.0), sizes=[0.25])
...
plt.subplot(3, 4, 5)
plt.scatter(get_tax(29.0), get_pris(29.0), sizes=[0.25])
plt.title("May 2007")
plt.ylabel("price")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
...
plt.subplot(3, 4, 6)
plt.scatter(get_tax(30.0), get_pris(30.0), sizes=[0.25])
plt.title("June 2007")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
plt.xticks([])
...
plt.subplot(3, 4, 7)
plt.scatter(get_tax(31.0), get_pris(31.0), sizes=[0.25])
plt.title("July 2007")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
plt.xticks([])
...
plt.subplot(3, 4, 8)
plt.scatter(get_tax(32.0), get_pris(32.0), sizes=[0.25])
...
plt.subplot(3, 4, 9)
plt.scatter(get_tax(33.0), get_pris(33.0), sizes=[0.25])
...
plt.subplot(3, 4, 10)
plt.scatter(get_tax(34.0), get_pris(34.0), sizes=[0.25])
...
plt.subplot(3, 4, 11)
plt.scatter(get_tax(35.0), get_pris(35.0), sizes=[0.25])
...
plt.subplot(3, 4, 12)
plt.scatter(get_tax(36.0), get_pris(36.0), sizes=[0.25])
...
# 2008 date v.s.price--------------------------------------------------
plt.subplot(3, 4, 1)
plt.scatter(get_tax(37.0), get_pris(37.0), sizes=[0.25])
...
plt.subplot(3, 4, 2)
plt.scatter(get_tax(38.0), get_pris(38.0), sizes=[0.25])
...
plt.subplot(3, 4, 3)
plt.scatter(get_tax(39.0), get_pris(39.0), sizes=[0.25])
...
plt.subplot(3, 4, 4)
plt.scatter(get_tax(40.0), get_pris(40.0), sizes=[0.25])
...
plt.subplot(3, 4, 5)
plt.scatter(get_tax(41.0), get_pris(41.0), sizes=[0.25])
plt.title("May 2008")
plt.ylabel("price")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
...
plt.subplot(3, 4, 6)
plt.scatter(get_tax(42.0), get_pris(42.0), sizes=[0.25])
plt.title("June 2008")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
plt.xticks([])
...
plt.subplot(3, 4, 7)
plt.scatter(get_tax(43.0), get_pris(43.0), sizes=[0.25])
plt.title("July 2008")
plt.xlim((0, 10000000))
plt.ylim((0, 10000000))
plt.xticks([])
...
plt.subplot(3, 4, 8)
plt.scatter(get_tax(44.0), get_pris(44.0), sizes=[0.25])
...
plt.subplot(3, 4, 9)
plt.scatter(get_tax(45.0), get_pris(45.0), sizes=[0.25])
...
plt.subplot(3, 4, 10)
plt.scatter(get_tax(46.0), get_pris(46.0), sizes=[0.25])
...
plt.subplot(3, 4, 11)
plt.scatter(get_tax(47.0), get_pris(47.0), sizes=[0.25])
...
plt.subplot(3, 4, 12)
plt.scatter(get_tax(48.0), get_pris(48.0), sizes=[0.25])
